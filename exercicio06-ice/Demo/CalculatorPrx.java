...
public interface CalculatorPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default float add(float a, float b, java.util.Map<String, String> context)
    {
        return _iceI_addAsync(a, b, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> addAsync(float a, float b)
    {
        return _iceI_addAsync(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> addAsync(float a, float b, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_addAsync(float iceP_a, float iceP_b, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "add", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeFloat(iceP_a);
                     ostr.writeFloat(iceP_b);
                 }, istr -> {
                     float ret;
                     ret = istr.readFloat();
                     return ret;
    ...
    default float sub(float a, float b)
    {
        return sub(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default float sub(float a, float b, java.util.Map<String, String> context)
    {
        return _iceI_subAsync(a, b, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> subAsync(float a, float b)
    {
        return _iceI_subAsync(a, b, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.Float> subAsync(float a, float b, java.util.Map<String, String> context)
    {
        return _iceI_subAsync(a, b, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> _iceI_subAsync(float iceP_a, float iceP_b, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.Float> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "sub", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeFloat(iceP_a);
                     ostr.writeFloat(iceP_b);
                 }, istr -> {
