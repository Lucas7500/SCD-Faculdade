...
public interface PrinterPrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return toUpper(s, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String toUpper(String s, java.util.Map<String, String> context)
    {
        return _iceI_toUpperAsync(s, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> toUpperAsync(String s)
    {
        return _iceI_toUpperAsync(s, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> toUpperAsync(String s, java.util.Map<String, String> context)
    {
        return _iceI_toUpperAsync(s, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_toUpperAsync(String iceP_s, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "toUpper", null, sync, null);
        f.invoke(true, context, null, ostr -> {
                     ostr.writeString(iceP_s);
                 }, istr -> {
                     String ret;
